...
public class RelationshipView {
	...
	public void display(Graphics g) {
		for(int i = 0; i < manager.getRelationList().size(); i++){
	        ...
	        case 0: g.drawLine(originX, originY, destinationX, destinationY);
	        	break; 
	        case 1: poly = makeTrianglePolygon();
	        		g.drawLine(poly.xpoints[2], poly.ypoints[2], destinationX, destinationY);
	        		g.fillPolygon(poly);
	        	break;
	        case 2: poly = makeDiamondPolygon();
	        		g.drawLine(poly.xpoints[2], poly.ypoints[2], destinationX, destinationY);
	        		g.drawPolygon(poly);
	        	break;
	        case 3: poly = makeDiamondPolygon();
	        		g.drawLine(poly.xpoints[2], poly.ypoints[2], destinationX, destinationY);
	        		g.fillPolygon(poly);
	        	break;
	        case 4: poly = makeTrianglePolygon();
					g.drawLine(poly.xpoints[2], poly.ypoints[2], destinationX, destinationY);
					g.drawPolygon(poly);
				break;
	        }
    ...
    public Polygon makeTrianglePolygon() {
        ...
        if(destinationY > (origin.getyPos() + origin.getHeight()) && (destinationX >= origin.getxPos() - 30 && destinationX <= (origin.getxPos() + origin.getWidth() + 30))) {
        ...
        } else if(destinationY < origin.getyPos() && (destinationX >= origin.getxPos() - 30 && destinationX <= (origin.getxPos() + origin.getWidth() + 30))) {
        	xPoints[0] = origin.getxPos() + (origin.getWidth() / 2);
