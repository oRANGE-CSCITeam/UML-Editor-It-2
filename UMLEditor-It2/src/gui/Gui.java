...
public class Gui extends JFrame implements MouseListener, ActionListener {
	...
	public Gui(Manager manager1) {
		...
		saveFile.setFileFilter(new FileNameExtensionFilter("SERIALIZED File", "ser"));
		openFile = new JFileChooser();
		openFile.setFileFilter(new FileNameExtensionFilter("SERIALIZED File", "ser"));
		...
		open.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int returnVal = openFile.showOpenDialog(Gui.this);
				manager.setSavePath(openFile.getSelectedFile() + "");
				manager.load();
				repaint();
		...
		save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int returnVal = saveFile.showSaveDialog(Gui.this);
				manager.setSavePath(saveFile.getSelectedFile() + ".ser");
				manager.save();
