...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public class CanvasNotification extends javax.swing.JDialog {
	     ...
	     */
	    public CanvasNotification(java.awt.Frame parent, boolean modal) {
	        super(parent, modal);
	        initComponents();
	    }
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(CanvasNotification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                CanvasNotification dialog = new CanvasNotification(new javax.swing.JFrame(), true);
	...
	public class giveClassNameNotification extends javax.swing.JDialog {
	     ...
	     */
	    public giveClassNameNotification(java.awt.Frame parent, boolean modal) {
	        super(parent, modal);
	        initComponents();
	    }
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(giveClassNameNotification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        } catch (InstantiationException ex) {
	            java.util.logging.Logger.getLogger(giveClassNameNotification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        } catch (IllegalAccessException ex) {
	            java.util.logging.Logger.getLogger(giveClassNameNotification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                giveClassNameNotification dialog = new giveClassNameNotification(new javax.swing.JFrame(), true);
	                dialog.addWindowListener(new java.awt.event.WindowAdapter() {
	                    @Override
	                    public void windowClosing(java.awt.event.WindowEvent e) {
	                        System.exit(0);
